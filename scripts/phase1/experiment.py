...
if __name__ == "__main__":
    if len(sys.argv) < 2 or sys.argv[1] in ["--help", "-h"]:
        print("Phase 1 Retrieval Experiment Runner")
        print()
        print("Usage:")
        print("  uv run python scripts/phase1/experiment.py <test-case.json>")
        print("  uv run python scripts/phase1/experiment.py --all")
        print("  uv run python scripts/phase1/experiment.py --help")
        print()
        print("Description:")
        print("  Runs memory retrieval experiments using vector similarity search")
        print("  with sqlite-vec and cosine distance ranking.")
        ...
        print("  - Ollama running locally with mxbai-embed-large model (for embeddings)")
